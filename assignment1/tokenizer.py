...
def test_tokenize_expression():
    ...
    tokens = tokenize("!5")
    assert(tokens == [{'tag': '!', 'value': '!', 'position': 0}, {'tag': 'number', 'value': 5, 'position': 1}, {'tag': 'end', 'value': '', 'position': 2}])
    tokens = tokenize("!0")
    assert(tokens == [{'tag': '!', 'value': '!', 'position': 0}, {'tag': 'number', 'value': 0, 'position': 1}, {'tag': 'end', 'value': '', 'position': 2}])
    tokens = tokenize("!(5+3)")
    assert(tokens == [{'tag': '!', 'value': '!', 'position': 0}, {'tag': '(', 'value': '(', 'position': 1}, {'tag': 'number', 'value': 5, 'position': 2}, {'tag': '+', 'value': '+', 'position': 3}, {'tag': 'number', 'value': 3, 'position': 4}, {'tag': ')', 'value': ')', 'position': 5}, {'tag': 'end', 'value': '', 'position': 6}])
