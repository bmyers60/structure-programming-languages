...
def test_parse_expression():
    ...
    ast, tokens = parse_expression(tokenize("!2"))
    assert(ast == {'tag': 'not', 'value': {'tag': 'number', 'value': 2, 'position': 1}})


    ast, tokens = parse_expression(tokenize("!(5+4)"))
    assert(ast == {'tag': 'not', 'value': {'tag': '+', 'left': {'tag': 'number', 'value': 5, 'position': 2}, 'right': {'tag': 'number', 'value': 4, 'position': 4}}})
